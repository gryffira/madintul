    ...
    <div class="row justify-content-center mb-4 block-img-video-1-wrap">
      <div class="row">
        ...
        <div class="col" style="padding-bottom: 20px">
          <div class="card" style=" border: none; background-color: #ffff;" data-aos="fade">
            <div class="card-body" style="width: 300;">
             {!! $videos->video_html !!}
             <h5 class="card-title" style="padding: none">{{$videos->title}}</h5>
           </div>
         </div>
       </div>
       @endforeach
