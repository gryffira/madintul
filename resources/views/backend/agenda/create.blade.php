...
<div class="content-wrapper" style="background-color: #fff">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Buat Agenda</span></h4>
			</div>
	...
	<div class="content">
		<div class="row">
			<!-- Detached content -->
				<!-- Basic layout-->
				<form action="{{ route('agenda.store') }}" method="POST" enctype="multipart/form-data" id='post-form'>
					@csrf
					<div class="panel panel-flat">
						...
						<div class="panel-body ">
							...
							<div class="form-group {{ $errors->has('tanggal_acara') ? 'has-error' : '' }}">
								...
								<input class="form-control" type="date" name="tanggal_acara">
							...
							<div class="form-group {{ $errors->has('isi') ? 'has-error' : '' }}">
								...
								<textarea rows="5" cols="5" class="form-control" name="isi"></textarea>
								@if($errors->has('isi'))
							...
							<div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
								...
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 200px; height: 100px;">
										<img src="{{ ($event->image_thumb_url) ? $event->image_thumb_url : 'http://placehold.it/200x150&text=Landscape' }}" alt="...">
									</div>
