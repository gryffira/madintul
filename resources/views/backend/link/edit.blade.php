...
<div class="content-wrapper" style="background-color: #fff">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit Link</span></h4>
			</div>
	...
	<div class="content">
		<div class="row">
			<!-- Detached content -->
			<!-- Basic layout-->
			<form action="{{ route('link.update', $link->id) }}" method="post" id='post-form'>
				@csrf
					@method('PATCH')
				<div class="panel panel-flat">
					...
					<div class="panel-body ">
						...
						<div class="form-group {{ $errors->has('judul') ? 'has-error' : '' }}">
							<label>Judul</label>
							<input type="text" class="form-control" placeholder="" name="judul" value="{{$link->judul}}">
							@if($errors->has('judul'))
