	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit Staff</span></h4>
			</div>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" name="nik" value="{{$staff->nik}}">
									</div>
									@if($errors->has('nik'))
								...
								<div class="form-group {{ $errors->has('nama_depan') ? 'has-error' : '' }}">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" name="nama_depan" value="{{$staff->nama_depan}}">
									</div>
								...
								<div class="form-group {{ $errors->has('nama_belakang') ? 'has-error' : '' }}">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" name="nama_belakang" value="{{$staff->nama_belakang}}">
									</div>
