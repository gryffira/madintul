...
<div class="content-wrapper" style="background-color: #fff">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit Iklan</span></h4>
			</div>
	...
	<div class="content">
		<div class="row">
			<!-- Detached content -->
				<!-- Basic layout-->
				<form action="{{ route('iklan.update', $ads->id) }}" method="post" enctype="multipart/form-data" id='post-form'>
					@csrf
					@method('PATCH')
					<div class="panel panel-flat">
						...
						<div class="panel-body ">
							...
							<div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
								<label>Judul</label>
								<input type="text" class="form-control" placeholder="" name="title" value="{{$ads->title}}"=>
								@if($errors->has('title'))
							...
							<div class="form-group {{ $errors->has('excerpt') ? 'has-error' : '' }}">
								...
								<textarea rows="5" cols="5" class="form-control" name="excerpt">{{$ads->excerpt}}</textarea>
							...
							<div class="form-group {{ $errors->has('url') ? 'has-error' : '' }}" style="padding-bottom: 20px">
								...
								<input type="text" class="form-control" placeholder="" name="url" value="{{$ads->url}}">
								@if($errors->has('url'))
							...
							<div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
								...
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<div class="fileinput-new thumbnail" style="width: 200px; height: 100px;">
										<img src="{{ $ads->image_url  ? $ads->image_url  : 'http://placehold.it/200x150&text=Landscape' }}" alt="...">
										<input name="image" value="{{$ads->image}}">
									</div>
