	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Tambah Santri</span></h4>
			</div>
				...
				<div class="panel panel-flat">
					...
					<div class="panel-body ">
						<div class="row">
								...
								<div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
											<img src="{{ ($santri->image_thumb_url) ? $santri->image_thumb_url : 'http://placehold.it/200x200&text=No+Image' }}" alt="...">
										</div>
							...
							<div class="col-sm-8">
								<div class="form-group {{ $errors->has('nis') ? 'has-error' : '' }} mb-2">
						...
						<div class="form-group" style="padding-bottom: 20px">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="" name="agama" >
							</div>
						</div>
						...
						<div class="form-group" style="padding-bottom: 20px">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="" name="nama_ayah" >
							</div>
						</div>
						<div class="form-group" style="padding-bottom: 20px">
							<label class="control-label col-lg-2">Pekerjaan Ayah</label>
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="" name="pekerjaan_ayah" >
							</div>
						</div>
						<div class="form-group" style="padding-bottom: 20px">
							<label class="control-label col-lg-2">Nama Ibu</label>
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="" name="nama_ibu" >
							</div>
						</div>
						<div class="form-group" style="padding-bottom: 20px">
							<label class="control-label col-lg-2">Pekerjaan Ibu</label>
							<div class="col-lg-10">
								<input type="text" class="form-control" placeholder="" name="pekerjaan_ibu" >
							</div>
						</div>
