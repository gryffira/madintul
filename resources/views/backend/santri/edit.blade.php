...
<div class="content-wrapper" style="background-color: #fff">
	...
	<div class="page-header page-header-default">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit Santri</span></h4>
			</div>
	...
	<div class="content">
		<div class="row">
			...
			<form class="form-horizontal" action="{{ route('santri.update', $santri->id) }}" method="post" enctype="multipart/form-data">
				@csrf
				@method('PATCH')
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="form-group {{ $errors->has('nis') ? 'has-error' : '' }}">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" name="nis" value="{{$santri->nis}}">
									</div>
									@if($errors->has('nis'))
								...
								<div class="form-group {{ $errors->has('nama_depan') ? 'has-error' : '' }}">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" name="nama_depan" value="{{$santri->nama_depan}}">
									</div>
								...
								<div class="form-group {{ $errors->has('nama_belakang') ? 'has-error' : '' }}">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" name="nama_belakang" value="{{$santri->nama_belakang}}">
									</div>
